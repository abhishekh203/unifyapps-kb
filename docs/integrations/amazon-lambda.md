# Amazon Lambda integration | connect with UnifyApps

Source: https://www.unifyapps.com/docs/unify-integrations/amazon-lambda
Section: integrations

---

Amazon Lambda is a serverless compute service that automatically runs code in response to events, scaling resources as needed. It allows developers to focus on application logic without managing servers.

Integrating Amazon Lambda provides scalable, cost-efficient, and serverless compute capabilities for event-driven applications with minimal operational overhead.

## Authentication

Ensure you have the following information ready for a seamless integration process:

- `Connection Name`**:** Choose a meaningful name for your connection. This name helps you identify the connection within your application or integration settings. It could be something descriptive like "MyAppAmazonLambdaIntegration".
- `Authentication Type`**:** Select the type of authentication for connecting to your Amazon Lambda account:
  - IAM Role
  - Access Key
...
5. Provide the username and select permissions (AmazonLambdaFullAccess) policies by selecting "`Attach policies directly`" and click on the create user button.
...
8. Treat the access key and secret access key with high confidentiality, as it allows access to your Amazon Lambda account.

  ![Frame 47 (2).png](_img/be0eb17aa5cde342.webp)
...
5. Check the "`Require external ID`" box and enter the External ID provided by UnifyApps.
  ...
  ![Frame 48 (1).png](_img/add7ec80ecac8d97.webp)
...
2. Search for the IAM role you need for the connection.
  ...
  ![Frame 49 (1).png](_img/91cce2d66b15f548.webp)
...
| Actions | Description |
|---|---|
| `Get function details` | Get function details in Amazon Lambda |
| `Invoke an AWS lambda function` | Invokes the selected lambda function in Amazon Lambda |

## Triggers

| Triggers | Description |
|---|---|
| `New function` | On new function polling for Amazon Lambda |
